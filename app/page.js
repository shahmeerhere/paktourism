      ...
      <section id="culture" className="bg-gray-100 py-20">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="mt-16 grid md:grid-cols-2 gap-12 text-left">
            {/* Lahore */}
            <div>
              <h4 className="text-2xl font-semibold mb-4">Lahore</h4>
              <p className="text-gray-700">
                The city of gardens and vibrant bazaars.
                Home to grand Mughal architecture and timeless food streets.
                A cultural heartbeat that never sleeps.
              </p>
            </div>

            {/* Multan */}
            <div>
              <h4 className="text-2xl font-semibold mb-4">Multan</h4>
              <p className="text-gray-700">
                The land of saints and Sufi shrines.
                Famous for blue pottery and rich handicrafts.
                A city glowing with spiritual warmth.
              </p>
            </div>

            {/* Karachi */}
            <div>
              <h4 className="text-2xl font-semibold mb-4">Karachi</h4>
              <p className="text-gray-700">
                A modern hub with deep cultural roots.
                Blends coastal charm with art and music.
                A city that fuels creativity and ambition.
              </p>
            </div>

            {/* Islamabad */}
            <div>
              <h4 className="text-2xl font-semibold mb-4">Islamabad</h4>
              <p className="text-gray-700">
                Known for its green avenues and modern design.
                Hosts museums and cultural festivals year round.
                A serene yet cultured capital.
              </p>
            </div>
          </div>
        </div>
    ...
    {[1, 2, 3, 4, 5, 6, 7, 8].map((n) => (
      ...
      <section id="contact" className="bg-green-700 py-20 text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="mb-8 max-w-xl mx-auto">Get insider tips, travel guides, and updates about Pakistan tourism directly in your inbox.</p>
          <form className="flex flex-col md:flex-row justify-center gap-4 max-w-2xl mx-auto">
            <input type="email" placeholder="Enter your email" value={email} onChange={(e) => setEmail(e.target.value)} className="px-4 py-3 rounded-lg text-gray-900 w-full" required />
            <button type="submit" className="px-6 py-3 bg-white text-green-700 rounded-lg font-semibold hover:bg-gray-100">Subscribe</button>
          </form>
        </div>
      </section>
